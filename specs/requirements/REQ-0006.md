...
## NFR
Performance: The notification must reach the supervisor within approximately 1 minute of the escalation event.
(Phase 2 structured NFR: metric = agent_response; target = notification delivery within 60 seconds of escalation)
